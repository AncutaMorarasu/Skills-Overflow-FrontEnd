            ...
            <tbody>
              {userProfile.map(({ userId, userName, firstName, lastName, email, role }) => (
                <tr key={userId}>
                  ...
                  <td>{role}</td>
                  <td>
                    <Button type="button" className="btn btn-success btn-table-update" onClick={() => { toggle(); setGetUserId(userId); setModalMessage("Are you sure you want to promote this user to admin?"); }}>Upgrade to admin</Button>
                    <Button type="button" className="btn btn-danger btn-table-update" onClick={() => { toggle(); setGetUserId(userId); setModalMessage("Are you sure you want to block this user?") }}>Block user</Button>
                  </td>
                </tr>
              ))}
            </tbody>
